# Contributing to fliegdoc

First and foremost, thank you! We appreciate that you want to contribute to fliegdoc, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for fliegdoc**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for fliegdoc:

- star the [project](https://fliegwerk.github.io/fliegdoc)
- tweet your support for fliegdoc
...
- **version**: (required) please note the version of fliegdoc are you using
- **error messages**: (required) please paste any error messages into the issue, or a [gist](https://gist.github.com/)
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using

### Closing issues

The original poster or the maintainers of fliegdoc may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/fliegdoc
